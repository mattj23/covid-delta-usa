"""
    This script explores the difference between incubation and infection curves of different shapes
"""
...
def main():
    ...
    c0 = properties.alpha.infectivity.scale_x_positive(2, 1.5, "quadratic").mean_filter(3).normalize_area()
    c0.plot(ax2, color="lightblue", linewidth=3, label="Stretched")
